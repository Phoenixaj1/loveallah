...
class LA_DB {
	...
	private static function seed_scholars() {
		...
		$scholars = [
			...
			// ─── WAVE 72: PORTRAIT-FIRST CONTENT (Shorts-heavy creators) ───
			// Focus: channels whose primary output is portrait-orientation
			// short clips. These give the best mobile UX because they fill
			// the viewport. yt-dlp pulls their /shorts tab → all portrait.

			// Shorts-heavy modern du'aat
			[ 'username' => 'mohamedhoblos', 'display_name' => 'Mohamed Hoblos',
			  'bio' => 'Australian sheikh — powerful short reminders, massive Shorts audience.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@mohamedhoblosofficial',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'alihammuda', 'display_name' => 'Sh. Ali Hammuda',
			  'bio' => 'UK-based scholar (Wales Islamic Cultural Centre) — articulate Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@AliHammuda',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'muftiakmal', 'display_name' => 'Mufti Akmal',
			  'bio' => 'UK Mufti — short Urdu/English Q&A reminders, high Shorts cadence.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@MuftiAkmal',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'belalkhan', 'display_name' => 'Sh. Belal Khan',
			  'bio' => 'US-based imam, lots of short heart-softening reminders.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@BelalKhanOfficial',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'asimkhanofficial', 'display_name' => 'Sh. Asim Khan',
			  'bio' => 'UK imam — clear English reminders, Shorts-heavy.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@AsimKhanOfficial',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'tomfacchine', 'display_name' => 'Sh. Tom Facchine',
			  'bio' => 'US convert sheikh — Yaqeen Institute, concise Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@TomFacchine',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'suleimanhanispeaks', 'display_name' => 'Imam Suleiman Hani',
			  'bio' => 'US-based imam, philosophical Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@SuleimanHani',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'mubinshaikh', 'display_name' => 'Imam Mubin Shaikh',
			  'bio' => 'Canadian counter-extremism scholar — short reminders.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@MubinShaikh',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'haifahgalal', 'display_name' => 'Sh. Haifaa Younis',
			  'bio' => 'Founder of Jannah Institute — female scholar, gentle Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@JannahInstitute',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'iyadkhalil', 'display_name' => 'Imam Iyad Khalil',
			  'bio' => 'Saudi-trained UK scholar.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@iyadkhalil',
			  'default_content_type' => 'reminder' ],

			// Da'wah hubs (multi-scholar channels — heavy Shorts)
			[ 'username' => 'smile2jannah', 'display_name' => 'Smile2Jannah',
			  'bio' => 'Muhammad Khan — viral Shorts about Islam and life.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@Smile2Jannah',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'muslimlantern', 'display_name' => 'The Muslim Lantern',
			  'bio' => 'Daniel Haqiqatjou and guests — reflections + Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@TheMuslimLantern',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'onepathnetwork', 'display_name' => 'OnePath Network',
			  'bio' => 'Australian Muslim media — viral Shorts and reminders.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@OnePathNetwork',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'mercytomankind', 'display_name' => 'Mercy to Mankind',
			  'bio' => 'Da\'wah channel — reminders and Sira Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@MercytoMankind',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'iera_official', 'display_name' => 'iERA',
			  'bio' => 'Islamic Education and Research Academy — UK da\'wah.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@iERAofficial',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'thethinkingmuslim', 'display_name' => 'The Thinking Muslim',
			  'bio' => 'Muhammad Jalal — current-affairs podcast Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@TheThinkingMuslim',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'thedeenshow', 'display_name' => 'The Deen Show',
			  'bio' => 'Eddie Redzovic — Islamic Q&A, Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@DeenShowTV',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'aalimnetwork', 'display_name' => 'Aalim Network',
			  'bio' => 'UK-based mufti collective — Shorts on fiqh and adab.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@AalimNetwork',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'fcb_madinatulilm', 'display_name' => 'Madinatul-Ilm',
			  'bio' => 'Bradford-based UK scholar reminders, lots of Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@madinatulilm',
			  'default_content_type' => 'reminder' ],

			// Female scholars
			[ 'username' => 'haleh_banani', 'display_name' => 'Dr Haleh Banani',
			  'bio' => 'Family therapist + Islamic counselling — heart-led Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@DrHalehBanani',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'rabia_brown', 'display_name' => 'Rabia Brown',
			  'bio' => 'Convert revert journey + reminders.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Rabia+Brown+Islam',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'sumayyahsiddiqi', 'display_name' => 'Sumayyah Siddiqi',
			  'bio' => 'UK-based teacher — short tafsir reminders.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Sumayyah+Siddiqi',
			  'default_content_type' => 'reminder' ],

			// Modern qaris with Shorts
			[ 'username' => 'idrisabkar', 'display_name' => 'Sh. Idris Abkar',
			  'bio' => 'Beautiful Saudi qari — Shorts of Qur\'an highlights.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@idrisabkar',
			  'default_content_type' => 'qirat' ],
			[ 'username' => 'omarhishamalarabi', 'display_name' => 'Omar Hisham Al Arabi',
			  'bio' => 'Egyptian-American qari — viral Shorts of recitation loops.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@OmarHishamArabi',
			  'default_content_type' => 'qirat' ],
			[ 'username' => 'yasseraldosari', 'display_name' => 'Sh. Yasser Al-Dosari',
			  'bio' => 'Imam of Makkah — viral Shorts of Haram-style recitation.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@YasserAlDosariOfficial',
			  'default_content_type' => 'qirat' ],
			[ 'username' => 'salahmusally', 'display_name' => 'Sh. Salah Mussally',
			  'bio' => 'Young Egyptian qari — short emotional recitations.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Salah+Mussally+Quran',
			  'default_content_type' => 'qirat' ],
			[ 'username' => 'islammostafa', 'display_name' => 'Islam Sobhi',
			  'bio' => 'Young Egyptian qari — Shorts featuring his soft voice.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Islam+Sobhi+Quran',
			  'default_content_type' => 'qirat' ],
			[ 'username' => 'ahmedhussainali', 'display_name' => 'Sh. Ahmed Hussain Ali',
			  'bio' => 'Beautiful qira\'at — short loops.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Ahmed+Hussain+Ali+Quran',
			  'default_content_type' => 'qirat' ],
			[ 'username' => 'wadeemyahya', 'display_name' => 'Sh. Wadee Yahya Al-Yamani',
			  'bio' => 'Yemeni qari — popular on Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Wadee+Yahya+Al+Yamani+Quran',
			  'default_content_type' => 'qirat' ],

			// Knowledge / community (English)
			[ 'username' => 'khalidlatifofficial', 'display_name' => 'Imam Khalid Latif',
			  'bio' => 'Chaplain at NYU — Shorts on contemporary Muslim life.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@KhalidLatifNYU',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'mokhtaarmaghraoui', 'display_name' => 'Sh. Mokhtar Maghraoui',
			  'bio' => 'US-based scholar — heart-focused reminders.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@TheUnityRoad',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'mhshakir', 'display_name' => 'Sh. Muhammad Shakir',
			  'bio' => 'US-based teacher — fiqh and adab Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Sh+Muhammad+Shakir',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'sajidlipham', 'display_name' => 'Sh. Sajid Lipham',
			  'bio' => 'Young US imam — quick reminders.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@SajidLipham',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'mzakikamdar', 'display_name' => 'Sh. Mohammed Zaki Kamdar',
			  'bio' => 'UK-based Deobandi scholar — Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Mohammed+Zaki+Kamdar',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'mansoorhassan', 'display_name' => 'Sh. Mansoor Hassan',
			  'bio' => 'UK Deobandi scholar reminders.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Mansoor+Hassan+islamic',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'amrkhaledofficial', 'display_name' => 'Dr Amr Khaled',
			  'bio' => 'Egyptian preacher — translated Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@AmrKhaled',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'mostafahosny', 'display_name' => 'Sh. Mostafa Hosny',
			  'bio' => 'Egyptian preacher — Shorts of Sira reminders.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@MostafaHosnyOfficial',
			  'default_content_type' => 'reminder' ],

			// Specific Salafi voices (clear-aqeedah audience)
			[ 'username' => 'salafiyyahuk', 'display_name' => 'Salafi Sounds',
			  'bio' => 'UK Salafi reminders — Birmingham scholars.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@SalafiSounds',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'abuiyaadsalafi', 'display_name' => 'Abu Iyaad',
			  'bio' => 'UK Salafi scholar — short clear reminders.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Abu+Iyaad+Salafi',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'abuKhadeejahsalafi', 'display_name' => 'Abu Khadeejah',
			  'bio' => 'Birmingham Salafi scholar — Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@AbuKhadeejahOfficial',
			  'default_content_type' => 'reminder' ],

			// International / non-English
			[ 'username' => 'aboutaymiyyahyt', 'display_name' => 'Sh. Abu Taymiyyah',
			  'bio' => 'UK-based Yemeni scholar — Shorts on adab and aqeedah.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@AbuTaymiyyahOfficial',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'eddyredzovic', 'display_name' => 'Eddie Redzovic',
			  'bio' => 'Deen Show host — viral revert Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@EddyRedzovic',
			  'default_content_type' => 'reminder' ],

			// More Shorts-heavy independents (search-resolved if direct handle uncertain)
			[ 'username' => 'islamicguidance', 'display_name' => 'Islamic Guidance',
			  'bio' => 'Aggregates Shorts from established scholars with attribution.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@IslamicGuidance',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'islamicvideo', 'display_name' => 'IslamicVideo',
			  'bio' => 'Curated Shorts of scholar reminders.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Islamic+Video+Shorts+reminder',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'kalemmat', 'display_name' => 'Kalemmat',
			  'bio' => 'Arabic Shorts — short heart reminders.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@Kalemmat',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'ibntaymiyyahteachings', 'display_name' => 'Ibn Taymiyyah Teachings',
			  'bio' => 'Curated short quotes and reminders.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Ibn+Taymiyyah+teachings+shorts',
			  'default_content_type' => 'reminder' ],

			// ─── WAVE 73: MASSIVE EXPANSION — 50+ more Muslim creators ──

			// Big-audience English du'aat
			[ 'username' => 'yahyaibrahim', 'display_name' => 'Sh. Yahya Ibrahim',
			  'bio' => 'Australian scholar with global reach — practical Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Yahya+Ibrahim+sheikh',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'ammaralshukry', 'display_name' => 'Imam Ammar AlShukry',
			  'bio' => 'US-based imam — viral reminders + Sira.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@AmmarAlShukry',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'yusufchambers', 'display_name' => 'Yusuf Chambers',
			  'bio' => 'UK convert speaker — Peace TV reminders.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Yusuf+Chambers+islam',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'yusha_evans', 'display_name' => 'Yusha Evans',
			  'bio' => 'American convert speaker — emotive revert journey content.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@YushaEvansOfficial',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'hamzatzortzis', 'display_name' => 'Hamza Andreas Tzortzis',
			  'bio' => 'iERA — apologetics + Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@HamzaAndreasTzortzis',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'muezza_studios', 'display_name' => 'Muezza',
			  'bio' => 'Animated reminders + Sira Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@Muezza',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'islamicvision', 'display_name' => 'Islamic Vision',
			  'bio' => 'Da\'wah animation channel — kid-friendly Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Islamic+Vision+animation',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'subhialshaer', 'display_name' => 'Sh. Subhi Alshaer',
			  'bio' => 'Yemen-trained UK-based scholar.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Subhi+Alshaer',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'waleadmosaad', 'display_name' => 'Sh. Walead Mosaad',
			  'bio' => 'US-based traditional scholar — Shorts on Imam Malik\'s tradition.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@waleadmosaad',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'muizbukhary', 'display_name' => 'Sh. Muiz Bukhary',
			  'bio' => 'Sri Lankan scholar with global reach — heart reminders.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@MuizBukhary',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'muhammad_tayyib', 'display_name' => 'Mufti Muhammad Tayyab',
			  'bio' => 'UK Mufti — short fiqh and adab clips.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Mufti+Muhammad+Tayyab',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'mufti_ismail_kassim', 'display_name' => 'Mufti Ismail Kassim',
			  'bio' => 'UK-based scholar — Q&A Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Mufti+Ismail+Kassim',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'shaykhmurtaza', 'display_name' => 'Sh. Murtaza Khan',
			  'bio' => 'UK Salafi speaker.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Sh+Murtaza+Khan',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'mizanur_rahman', 'display_name' => 'Sh. Mizanur Rahman',
			  'bio' => 'UK scholar — Tafsir Shorts and reminders.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Mizanur+Rahman+islam',
			  'default_content_type' => 'reminder' ],

			// Sira / history / animation
			[ 'username' => 'studio_dawah', 'display_name' => 'Studio Dawah',
			  'bio' => 'Da\'wah-focused animation studio — Sira Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@StudioDawah',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'alphasira', 'display_name' => 'AlphaSira',
			  'bio' => 'Sira and history Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=AlphaSira',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'islamic_history_official', 'display_name' => 'Islamic History',
			  'bio' => 'Animated Islamic history Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Islamic+history+animation+shorts',
			  'default_content_type' => 'reminder' ],

			// Female speakers
			[ 'username' => 'noorhasan', 'display_name' => 'Noor Hasan',
			  'bio' => 'Heart-led reminders on family life.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Noor+Hasan+islam',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'iesha_prime', 'display_name' => 'Ustadha Iesha Prime',
			  'bio' => 'US scholar — Quran teacher with viral clips.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Ustadha+Iesha+Prime',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'naima_b_robert', 'display_name' => 'Na\'ima B. Robert',
			  'bio' => 'Author + UK speaker — practical Islam Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Naima+B+Robert',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'tesneem_alkiek', 'display_name' => 'Dr Tesneem Alkiek',
			  'bio' => 'Yaqeen Institute scholar — Shorts on women in Islam.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Tesneem+Alkiek',
			  'default_content_type' => 'reminder' ],

			// More qaris with Shorts
			[ 'username' => 'fares_abbad', 'display_name' => 'Sh. Fares Abbad',
			  'bio' => 'Yemeni qari — viral Shorts of recitation.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Fares+Abbad+Quran',
			  'default_content_type' => 'qirat' ],
			[ 'username' => 'mohamed_taha', 'display_name' => 'Sh. Mohamed Taha',
			  'bio' => 'Egyptian qari — recitation Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Mohamed+Taha+Quran',
			  'default_content_type' => 'qirat' ],
			[ 'username' => 'ahmad_al_nufais', 'display_name' => 'Sh. Ahmad Al-Nufais',
			  'bio' => 'Saudi qari with melodic recitation.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Ahmad+Al+Nufais+Quran',
			  'default_content_type' => 'qirat' ],
			[ 'username' => 'tawfeeq_as_sayegh', 'display_name' => 'Sh. Tawfeeq As-Sayegh',
			  'bio' => 'Saudi qari — Shorts of his soft recitation.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Tawfeeq+As+Sayegh',
			  'default_content_type' => 'qirat' ],
			[ 'username' => 'abubakr_alshatri', 'display_name' => 'Sh. Abu Bakr Al-Shatri',
			  'bio' => 'Saudi qari — classic Hafs.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Abu+Bakr+Al+Shatri+Quran',
			  'default_content_type' => 'qirat' ],
			[ 'username' => 'abdullahmatrood', 'display_name' => 'Sh. Abdullah Al-Matrood',
			  'bio' => 'Saudi qari — soothing tone Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Abdullah+Al+Matrood',
			  'default_content_type' => 'qirat' ],
			[ 'username' => 'hani_arrifai', 'display_name' => 'Sh. Hani Ar-Rifai',
			  'bio' => 'Saudi qari — viral Quran Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Hani+Ar+Rifai+Quran',
			  'default_content_type' => 'qirat' ],
			[ 'username' => 'sudais_official', 'display_name' => 'Sh. Abdurrahman Al-Sudais',
			  'bio' => 'Head of the Two Holy Mosques — Imam of Makkah.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Sudais+Quran',
			  'default_content_type' => 'qirat' ],
			[ 'username' => 'khalifa_altunaiji', 'display_name' => 'Sh. Khalifa Al-Tunaiji',
			  'bio' => 'UAE qari with Shorts following.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Khalifa+Al+Tunaiji',
			  'default_content_type' => 'qirat' ],
			[ 'username' => 'huzaifi_qari', 'display_name' => 'Sh. Ali Al-Hudhaifi',
			  'bio' => 'Imam of Madinah — classical Hafs.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Ali+Al+Hudhaifi+Quran',
			  'default_content_type' => 'qirat' ],

			// Indonesia / SE Asia (huge audience)
			[ 'username' => 'hananattaki', 'display_name' => 'Ustadz Hanan Attaki',
			  'bio' => 'Indonesian preacher — massive Shorts following.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@hananattaki',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'khalidbasalamah', 'display_name' => 'Ustadz Khalid Basalamah',
			  'bio' => 'Indonesian Salafi preacher — Shorts and Q&A.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@KhalidBasalamahOfficial',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'adisomad', 'display_name' => 'Ustadz Adi Hidayat',
			  'bio' => 'Popular Indonesian scholar — fiqh + Tafsir Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Adi+Hidayat+islam',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'aagym', 'display_name' => 'Aa Gym',
			  'bio' => 'Abdullah Gymnastiar — Indonesian heart-led reminders.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Aa+Gym+ceramah',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'ustadz_yusuf_mansur', 'display_name' => 'Ustadz Yusuf Mansur',
			  'bio' => 'Indonesian preacher with mainstream reach.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Yusuf+Mansur',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'azhar_idrus', 'display_name' => 'Ustaz Azhar Idrus',
			  'bio' => 'Malaysian preacher — Q&A Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Azhar+Idrus',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'mufti_menk_my', 'display_name' => 'Dr Maza',
			  'bio' => 'Asri Zainul Abidin — Malaysian scholar.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Dr+Asri+Zainul+Abidin',
			  'default_content_type' => 'reminder' ],

			// Pakistan / South Asia (Urdu — big audience)
			[ 'username' => 'tariqjameel', 'display_name' => 'Maulana Tariq Jameel',
			  'bio' => 'Most-watched Urdu speaker in Pakistan — translated clips available.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Maulana+Tariq+Jameel',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'muhammadalimirza', 'display_name' => 'Engineer Muhammad Ali Mirza',
			  'bio' => 'Pakistani scholar — heated Q&A on aqeedah and history.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@EngineerMuhammadAliMirza',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'javed_ghamidi', 'display_name' => 'Dr Javed Ahmad Ghamidi',
			  'bio' => 'Renowned Pakistani scholar — Quran-centric reformist.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Javed+Ahmad+Ghamidi',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'muftirafiusmani', 'display_name' => 'Mufti Rafi Usmani',
			  'bio' => 'Late great Pakistani Mufti — translated short clips.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Mufti+Rafi+Usmani',
			  'default_content_type' => 'reminder' ],

			// Reverts / journey channels
			[ 'username' => 'muslim_convert_stories', 'display_name' => 'Muslim Convert Stories',
			  'bio' => 'Curated convert testimonials and reminders.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=muslim+convert+story+islam',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'merciful_servant', 'display_name' => 'The Merciful Servant',
			  'bio' => 'Curated lecture Shorts from established scholars.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@TheMercifulServant',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'islamic_reminders_hd', 'display_name' => 'Islamic Reminders HD',
			  'bio' => 'Curated short reminders from various scholars.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Islamic+Reminders+HD',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'soft_hearted', 'display_name' => 'Soft Hearted',
			  'bio' => 'Heart-softening Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Soft+Hearted+islam+shorts',
			  'default_content_type' => 'reminder' ],

			// Specific aqeedah / fiqh voices (modern)
			[ 'username' => 'asrarrashidofficial', 'display_name' => 'Sh. Asrar Rashid',
			  'bio' => 'UK Hanafi scholar — Shorts on aqeedah and history.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/@AsrarRashidOfficial',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'muhammadyasin', 'display_name' => 'Sh. Muhammad Yasin',
			  'bio' => 'UK scholar — heart-focused content.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Sh+Muhammad+Yasin+islam',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'imamtomdavis', 'display_name' => 'Imam Tom Davis',
			  'bio' => 'US revert + modern issues Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Imam+Tom+Davis',
			  'default_content_type' => 'reminder' ],

			// Tafsir-focused
			[ 'username' => 'tafseershow', 'display_name' => 'Tafseer Show',
			  'bio' => 'Curated tafsir Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Tafseer+show+shorts',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'quranforall', 'display_name' => 'Quran For All',
			  'bio' => 'Curated Quran study Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Quran+for+all',
			  'default_content_type' => 'reminder' ],

			// Family / counsellor
			[ 'username' => 'imam_omar_husain', 'display_name' => 'Imam Omar Husain',
			  'bio' => 'US imam — marriage and parenting Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Imam+Omar+Husain',
			  'default_content_type' => 'reminder' ],
			[ 'username' => 'mawlimohamed', 'display_name' => 'Sh. Mawli Mohamed',
			  'bio' => 'UK speaker — practical family Shorts.',
			  'account_type' => 'curated',
			  'source_url' => 'https://www.youtube.com/results?search_query=Mawli+Mohamed+islam',
			  'default_content_type' => 'reminder' ],
