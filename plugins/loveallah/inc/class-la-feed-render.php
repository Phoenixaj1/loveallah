	...
	public static function content_card( $card ) : void {
		...
		<article class="la-snap la-snap--content"
			...
			<div class="la-snap-actions" aria-label="Post actions">
				...
				<button type="button" class="la-snap-action" data-act="like" data-id="<?php echo (int) $card->id; ?>" aria-label="Like">
				...
				<button type="button" class="la-snap-action" data-act="save" data-id="<?php echo (int) $card->id; ?>" aria-label="Save">
					...
					<span class="la-snap-action-count">Save</span>
				</button>
